...
def give_games(year_string, season='Regular Season'):
    ...
    Input: year string like '2022-2023', season type like 'Regular Season' or 'Playoffs' or 'All-Star'
    Output: LeagueGameLog
    """
    game_log_response = leaguegamelog.LeagueGameLog(counter='0', direction='ASC', league_id='00', player_or_team_abbreviation='T', season=year_string, season_type_all_star=season, sorter='Date')
